...
Hyperprogramming makes use of a different kind of infrastructure than that which is currently used.  Lack of appropriate infrastructure would have inhibited exploration of this approach in the past.  In fact, the idea may have eluded awareness completely due to the absence of tool affordances that even suggest it.  Before we can properly investigate the effectiveness of hyperprogramming we must invest in new tools and repurpose some existing ones.
