...
(list title
  (writing-content
    ...
    `(section
       ...
       (p "What seems to be missing is an organizational phase for " (strong "breaking concepts down") " into clear, implementable pieces.  Most importantly, " (strong "thoughts/findings should be written down") " in some way while operating in this phase in order " (strong "to reduce the cognitive load of later phases") ".  Such a process lowers the activation energy required for getting started with the actual programming.  This planning process can be " (strong "performed gradually") ", and so has low activation energy requirements itself, completing a cycle requiring only low energy transitions.  I suspect this phase is harder to find and develop because it feels more like work.")
       (p "Some companies incorporate a similar organizational phase into a formal process involving planning documents, formal specifications and project/task management tools.  While you can do these things, for my personal work I " (strong "use simple text to quickly dump thoughts, take notes and sketch TODO lists without imposing unwanted structure."))
       (p "One problem with typical formal processes is that the structure they impose increases activation energy requirements.  Fitting the structure becomes an additional problem to solve, adding friction.  " (strong "Friction kills unborn ideas") ", so I " (strong "write freely before structuring") ".  When forced to operate within a formal process, I still work within my own informal process for efficiency.  I then translate to the formal process in batches to communicate with everyone else.")
